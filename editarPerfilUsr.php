...
<body>
    ...
    <div class="container">
        <div class="dados-usr dados-usr_edit">
            <?php
            if (isset($_SESSION['id_Usr'])) {
                ...
                if ($result->num_rows > 0) {
                    ...
                    if (empty($row['imgData'])) {
                        ...
                        echo "<img src='$imgUsr' alt='Imagem do Usuario' class='imgUsr imgUsr_edit'><br><br>";
                    } 
                    ...
                    echo "<form method='POST' class='form_usr_edit' enctype='multipart/form-data'>";
                    echo"<div class='input_file input_file_edit'>";
                    ...
                    echo "<input type='text' class='inp_dados' name='pfName' value='" . $row["usrName"] . "''><br><br>";
                    echo "</div>";
                    echo "<div class='area'>";
