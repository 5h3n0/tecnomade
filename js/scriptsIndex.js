 ...
 document.addEventListener("DOMContentLoaded", function() {
    ...
    function sendNewMessage() {
        ...
        var keywords = [
            ...
            { words: ['olá', 'oi', 'iae','eae','hello','tec','opa'], response: 'Olá! Como posso ajudar você hoje?' },
            { words: ['tudo bem', 'como vai', 'tranquilo'], response: 'Tudo sim e com você? <br> Como posso ajudar você hoje?' },
            { words: ['tchau','até', 'ate', 'flw'], response: 'Até mais, qualquer coisa estarei aqui para ajudar' },
            { words: ['obg', 'obrigado', 'vlw', 'tmj', 'obrigada'], response: 'Por nada, fico feliz em conseguir ajudar. qualquer coisa só me procurar' },
