...
<body>
    <form method="post" action="endPfBd.php" class="endPf">
        ...
        <input name="cep" type="text" id="cep" value="" maxlength="9" onblur="pesquisacep(this.value);"
            autocomplete="off" oninput="formatCep(this)" placeholder="Ex: 08000-000">
        ...
        <label for="comp" class="lbls">Complemento:</label>
